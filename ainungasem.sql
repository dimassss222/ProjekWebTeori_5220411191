...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jan 2024 pada 09.02
...
-- Fungsi
--
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodefaktur` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodeitem` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodejurnal` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodejurnalumum` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
  SET firstkode = CONCAT('J',DATE_FORMAT(CURRENT_DATE(),'%y%m%d'));
  SET @notrans = 0;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodememo` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
  SET @vartipe = '#MEMO';
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodepembayaran` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodepembelian` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
  SET firstkode = CONCAT('#PAY',DATE_FORMAT(CURRENT_DATE(),'%y%m%d'));
  SET @notrans = 0;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodepemesanan` (`xtipe` CHAR(1)) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodepenerimaan` (`xtipe` CHAR(1)) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodepengeluarankas` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodepengiriman` (`xtipe` CHAR(1)) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
  SET @vartipe = ( IF(xtipe = 1, '#TRM', '#KRM') );
  SET firstkode = CONCAT(@vartipe,DATE_FORMAT(CURRENT_DATE(),'%y%m%d'));
  SET @notrans = 0;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecoderetur` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatecodestokopname` () RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
  DECLARE firstkode VARCHAR(20);
  SET @vartipe = '#STO';
  SET firstkode = CONCAT(@vartipe,DATE_FORMAT(CURRENT_DATE(),'%y%m%d'));
  SET @notrans = 0;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `generatenoakun` (`xnoheader` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci READS SQL DATA BEGIN
...
--
-- Struktur dari tabel `tbl_cart_pembelian`
--
...
--
-- Dumping data untuk tabel `tbl_cart_pembelian`
--
...
--
-- Struktur dari tabel `tbl_faktur_pembelian`
--
...
--
-- Struktur dari tabel `tbl_header_akun`
--
...
--
-- Dumping data untuk tabel `tbl_header_akun`
--
...
--
-- Struktur dari tabel `tbl_stock_bahan`
--
...
--
-- Struktur dari tabel `tbl_stock_produk`
--
...
--
-- Dumping data untuk tabel `tbl_stock_produk`
--
...
(8, 'Ahmad Yusuf', 'admin', '$2y$10$nx7RSChSjNhYGDA7Sy3KXO1H4u5TdtJmxiZdmcMlP8vie.2hnrnR2', 'default.jpg', 4, 1, 1583038076),
...
--
-- Indeks untuk tabel `tbl_cart_pembelian`
--
...
--
-- Indeks untuk tabel `tbl_faktur_pembelian`
--
ALTER TABLE `tbl_faktur_pembelian`
  ADD PRIMARY KEY (`id_faktur_pembelian`);

--
-- Indeks untuk tabel `tbl_header_akun`
--
...
--
-- Indeks untuk tabel `tbl_stock_bahan`
--
...
--
-- Indeks untuk tabel `tbl_stock_produk`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_beban`
--
ALTER TABLE `tbl_beban`
  MODIFY `id_beban` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_cart_pembelian`
--
ALTER TABLE `tbl_cart_pembelian`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_faktur_pembelian`
--
ALTER TABLE `tbl_faktur_pembelian`
  MODIFY `id_faktur_pembelian` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_header_akun`
--
ALTER TABLE `tbl_header_akun`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_stock_bahan`
--
ALTER TABLE `tbl_stock_bahan`
  MODIFY `id_stock_b` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_stock_produk`
--
ALTER TABLE `tbl_stock_produk`
...
--
-- Ketidakleluasaan untuk tabel `tbl_stock_bahan`
--
ALTER TABLE `tbl_stock_bahan`
...
--
-- Ketidakleluasaan untuk tabel `tbl_stock_produk`
--
ALTER TABLE `tbl_stock_produk`
